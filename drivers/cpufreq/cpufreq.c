...
#define CONFIG_MSM_CPU_FREQ_MIN_GROUP1 5000
#define CONFIG_MSM_CPU_FREQ_MAX_GROUP1 2112000
#define CONFIG_MSM_CPU_FREQ_MIN_GROUP2 5000
#define CONFIG_MSM_CPU_FREQ_MAX_GROUP2 2592000

static inline int map_core_to_cluster(int core)
{
	// cores 0..3 are the little cluster, cores 4..7 are the big cluster
	if (core < 4)
		return 0;
